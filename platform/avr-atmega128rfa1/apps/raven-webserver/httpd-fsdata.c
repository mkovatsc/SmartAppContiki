/*********Generated by contiki/tools/makefsdata on 2011-07-22*********/
...
const char data_header_html[824] PROGMEM = {
  /* /header.html */
...
const char data_index_html[181] PROGMEM = {
  /* /index.html */
...
const struct httpd_fsdata_file file_processes_shtml[] PROGMEM ={{     file_index_html, data_processes_shtml, data_processes_shtml +17, sizeof(data_processes_shtml) -17}};
